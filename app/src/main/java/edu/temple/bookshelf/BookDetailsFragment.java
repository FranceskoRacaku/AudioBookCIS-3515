...
public class BookDetailsFragment extends Fragment {
    ...
    Button playBtn;
    PlayBookInterface parentActivity;
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof BookDetailsFragment.PlayBookInterface)
            parentActivity = (BookDetailsFragment.PlayBookInterface) context;
        else
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        playBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                parentActivity.playBook(book.getId(), book.getDuration());
            }
        });
    ...
    interface PlayBookInterface{
        void playBook(int id, int duration);
    }
